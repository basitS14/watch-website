...
<head>
    ...
    <title>NovaChrono | Your Watch HUB</title>
 ...
 <div class="container pt-3">
        <div class="row text-center ">
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#watch"> <img src="images/smart.jpg" class="img-fluid1" alt="" >
            ...
            <div class="col-6 col-md-3 py-3 " >
                <a href="products.php#shirt"  >
                  <img src="images/analog.jpg" class="img-fluid1" alt=""  >
                     <div class="h5 pt-3 font-weight-bolder">
                        Analog Watches
                     </div>
                  </a>
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#shoes">
                 <img src="images/digital.jpg" class="img-fluid1" alt="" >
                <div class="h5 pt-3 font-weight-bolder">
                    Digital Watches
                 </div>
             </a>
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#headphones">
                 <img src="images/fitness.jpg" class="img-fluid1" alt=""  >
                 <div class="h5 pt-3 font-weight-bolder">
                    Fitness Bands
                 </div>
              </div>

...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,1)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">NovaChrono</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php" class="dropdown-item">Smart Watch</a>
                                   <a href="products.php" class="dropdown-item">Analog Watch </a>
                                   <a href="products.php" class="dropdown-item">Digital Watch</a>
                                   <a href="products.php" class="dropdown-item">Fitness Bands</a>
                               </div>
          ...
          <div class="modal-content" style="background-color:rgba(255,255,255,0.95)">
            ...
            <div class="modal-body">
              <form action="signup_script.php" method="post">
                ...
                <div class="form-group">
                        <label for="validation3">Address</label>
                        <input type="textarea" class="form-control" id="validation3"  name="address" placeholder="Address">
                </div>
                ...
                <button type="submit" class="btn btn-primary btn-block" name="Submit" required>Sign Up</button>
              </form>
            </div>
            <div class="modal-footer">
